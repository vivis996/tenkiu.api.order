...
using tenkiu.api.order.App.SellOrderApp;
...
) : ApiBaseController
{
  ...
  [HttpGet("{id:int}")]
  [AuthorizeJwt]
  [ProducesResponseType(typeof(SuccessResponse<ResponseSellOrderDto?>), StatusCodes.Status200OK)]
  [ProducesResponseType(typeof(FailureResponse), StatusCodes.Status500InternalServerError)]
  public async Task<BaseResponse<ResponseSellOrderDto?>> Get(int id)
  {
  ...
  [ProducesResponseType(typeof(SuccessResponse<ResponseSellOrderDto?>), StatusCodes.Status200OK)]
  [ProducesResponseType(typeof(FailureResponse), StatusCodes.Status500InternalServerError)]
  public async Task<BaseResponse<ResponseSellOrderDto?>> Get(string hash)
  {
  ...
  [HttpGet]
  [AuthorizeJwt]
  [ProducesResponseType(typeof(SuccessResponse<PaginationResponse<ResponseSellOrderDto>>), StatusCodes.Status200OK)]
  [ProducesResponseType(typeof(FailureResponse), StatusCodes.Status500InternalServerError)]
  public async Task<BaseResponse<PaginationResponse<ResponseSellOrderDto>>> Get([FromQuery] SellOrderSearchRequest searchRequest)
  {
  ...
  [ProducesResponseType(typeof(FailureResponse), StatusCodes.Status500InternalServerError)]
  public async Task<BaseResponse<int>> Post([FromBody] CreateSellOrderDto value)
  {
  ...
  [ProducesResponseType(typeof(FailureResponse), StatusCodes.Status500InternalServerError)]
  public async Task<BaseResponse<bool>> Put([FromBody] UpdateSellOrderDto value)
  {
